package com.robosoft.virtualLearn.profile.constants;
...
public class Constants {
    public static final String FIREBASE_SDK_JSON ="src/drivelistfilesapplication-firebase-adminsdk-ny679-8a0c60eb7d (1).json";
